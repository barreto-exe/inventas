...
public class AdminSQLiteOpenHelper extends SQLiteOpenHelper
{
    ...
    /**
     * String para crear tabla de Ventas que relaciona el ID de una venta con el ID de la tasa en el
     * momento de la venta, el monto total a pagar (en dólares), la fecha y hora en el que se
     * procesó la venta.
     */
    ...
    /**
     * String para crear tabla que relaciona el ID de una venta con los artículos pertenecientes a
     * dicha venta, la cantidad correspondiente a cada artículo y el Subtotal en dólares.
     */
    ...
    /**
     * String para crear tabla que relaciona el ID de una venta con el ID de la moneda que fue
     * utilizada para el pago de dicha venta, la descripción del tipo de pago, y el monto total que
     * fue cancelado bajo esa modalidad.
     */
    ...
    /**
     * String para crear tabla Monedas, donde guardan los IDs correspondientes a las monedas
     * aceptadas (Bolívar y Dólar)
     */
