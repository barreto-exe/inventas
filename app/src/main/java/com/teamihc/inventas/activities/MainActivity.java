...
public class MainActivity extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.top_establecer_delivery: {
                openEstablecerDelivery(null);
            }
        }
    ...
    public void openEstablecerDelivery(View view) {
        dialog.setContentView(R.layout.view_cambiar_delivery);
        dialog.getWindow().setBackgroundDrawable(new ColorDrawable(Color.TRANSPARENT));
        EditText distancia_corta = dialog.findViewById(R.id.distancia_corta);
        EditText distancia_media = dialog.findViewById(R.id.distancia_media);
        EditText distancia_larga = dialog.findViewById(R.id.distancia_larga);
        Button guardar = dialog.findViewById(R.id.guardarDelivery_bttn);
        guardar.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (!distancia_corta.getText().toString().isEmpty() && !distancia_media.getText().toString().isEmpty()
                        && !distancia_larga.getText().toString().isEmpty()) {
                    dialog.dismiss();
                    Toast.makeText(MainActivity.this, "Precios registrados.", Toast.LENGTH_SHORT).show();
